          ...
          {MOCK_ACHIEVEMENTS.map((ach) => (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  type="button"
                  className="ml-auto inline-flex h-6 w-11 items-center rounded-full bg-indigo-500/20 px-1 text-[10px] text-indigo-200"
                >
              ...
              <div className="mt-3 space-y-1.5">
                ...
                <div className="mt-2 space-y-0.5 text-[11px] text-slate-300">
                  ...
                  <p>
                    <span className="font-semibold text-cyan-300">Diamond</span>{" "}
                    {ach.diamond}
                  </p>
                </div>
              </div>
